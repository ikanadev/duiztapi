...
type UserEdges struct {
	...
	Responses []*Response
	// Quizes holds the value of the quizes edge.
	Quizes []*Quiz
...
// QuizesOrErr returns the Quizes value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) QuizesOrErr() ([]*Quiz, error) {
	if e.loadedTypes[1] {
		return e.Quizes, nil
	}
	return nil, &NotLoadedError{edge: "quizes"}
}
...
func (u *User) QueryResponses() *ResponseQuery {
	return (&UserClient{config: u.config}).QueryResponses(u)
}

// QueryQuizes queries the "quizes" edge of the User entity.
func (u *User) QueryQuizes() *QuizQuery {
	return (&UserClient{config: u.config}).QueryQuizes(u)
}
